...
List<Player> mainRecords = [];
  ...
  // final dataTwo = _.playerCashInOut[widget.index];
      ...
      // await FirebaseFirestore.instance.collection("users").doc(_.nn).collection("games").doc(_.ref!.id).collection("players");
                         ...
                         setState(() {
                          data.addresses.add(PlayerCashInOut(time: "${now.year.toString()}-${now.month.toString()}-${now.day.toString()}", buyIn: 0, amount:int.parse(amountController.text) ));
                    ...
                    Container(height: 27,width: 32,decoration: BoxDecoration(color: Color(0xFF99A0BA),borderRadius: BorderRadius.circular(10)),child: Icon(Icons.navigate_before,color: Colors.red,)),
                          ...
                          //  padding: EdgeInsets.all(8.0),
                            ...
                            child: Padding(
                              ...
                              child: Row(
                               mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                     Text('Date: ${data.addresses[i].time}'),
                                  Text('Address: ${data.addresses[i].amount}'),
                                  Text('Street: ${data.addresses[i].buyIn}'),
